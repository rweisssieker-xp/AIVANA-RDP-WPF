...
pub enum ConnectionFinalizationState {
    ...
    SendSynchronize,
    WaitForServerSynchronize,
    SendControlCooperate,
    WaitForServerCooperate,
    SendRequestControl,
    WaitForServerGrantedControl,
    SendFontList,
...
impl State for ConnectionFinalizationState {
    fn name(&self) -> &'static str {
        match self {
            ...
            Self::WaitForServerSynchronize => "WaitForServerSynchronize",
            Self::SendControlCooperate => "SendControlCooperate",
            Self::WaitForServerCooperate => "WaitForServerCooperate",
            Self::SendRequestControl => "SendRequestControl",
            Self::WaitForServerGrantedControl => "WaitForServerGrantedControl",
...
impl Sequence for ConnectionFinalizationSequence {
    fn next_pdu_hint(&self) -> Option<&dyn PduHint> {
        match self.state {
            ...
            ConnectionFinalizationState::WaitForServerSynchronize => Some(&ironrdp_pdu::X224_HINT),
            ConnectionFinalizationState::SendControlCooperate => None,
            ConnectionFinalizationState::WaitForServerCooperate => Some(&ironrdp_pdu::X224_HINT),
            ConnectionFinalizationState::SendRequestControl => None,
            ConnectionFinalizationState::WaitForServerGrantedControl => Some(&ironrdp_pdu::X224_HINT),
        ...
        let (written, next_state) = match mem::take(&mut self.state) {
            ...
            ConnectionFinalizationState::SendSynchronize => {
                ...
                (
                    ...
                    ConnectionFinalizationState::WaitForServerSynchronize,
                )
            }
            ...
            ConnectionFinalizationState::WaitForServerSynchronize => {
                ...
                let next_state = match ctx.pdu {
                    ShareDataPdu::Synchronize(_) => ConnectionFinalizationState::SendControlCooperate,
                    ...
                    _ => ConnectionFinalizationState::WaitForServerSynchronize,
                };
            ...
            ConnectionFinalizationState::SendControlCooperate => {
                ...
                (
                    Written::from_size(written)?,
                    ConnectionFinalizationState::WaitForServerCooperate,
                )
            }
            ...
            ConnectionFinalizationState::WaitForServerCooperate => {
                ...
                let next_state = match ctx.pdu {
                    ShareDataPdu::Control(control_pdu)
                        if control_pdu.action == finalization_messages::ControlAction::Cooperate =>
                    {
                    ...
                    _ => ConnectionFinalizationState::WaitForServerCooperate,
                };
            ...
            ConnectionFinalizationState::SendRequestControl => {
                ...
                (
                    Written::from_size(written)?,
                    ConnectionFinalizationState::WaitForServerGrantedControl,
                )
            }
            ...
            ConnectionFinalizationState::WaitForServerGrantedControl => {
                ...
                let next_state = match ctx.pdu {
                    ShareDataPdu::Control(control_pdu)
                        if control_pdu.action == finalization_messages::ControlAction::GrantedControl =>
                    {
                    ...
                    _ => ConnectionFinalizationState::WaitForServerGrantedControl,
                };
